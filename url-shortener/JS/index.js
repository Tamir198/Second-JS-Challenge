...
const input = document.getElementById('link-to-shorten');
const form = document.querySelector('form');
const linkList = document.getElementById('shortened-link');

form.addEventListener('submit', (e) => {
    e.preventDefault();

    fetch('https://cors-anywhere.herokuapp.com/https://hideuri.com/api/v1/shorten',{
        method:"POST",
        body:{
